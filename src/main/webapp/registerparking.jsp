...
<html>
    ...
    <body>
       ...
       <center>
       <br>
       <b style="border-bottom:solid;">Register Parking Area</b><br><br>
       <form action="registerparkingcode.jsp" method="post">
       <input type="text" name="parkingid" placeholder="Parking Id"><br><br>
