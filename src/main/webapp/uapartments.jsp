    ...
    <body>
        <div class="content">
          ...
          <a href="urequestservices.jsp"><p class="dash">Request Services</p></a>
            ...
            try{
            	...
            	PreparedStatement ps=con.prepareStatement("select * from residentdata");
       ...
       <div class="new">
        <%  while(rs.next()){ %>
            	...
            	<div class="dn"><b style="font-size:18px;"><%=rs.getString(1)%></b><br>
            	Block:<%=rs.getString(3) %><br>Flat:<%=rs.getString(2) %><br>phone:<%=rs.getInt(5) %><br>From:<%=rs.getString(6) %>
