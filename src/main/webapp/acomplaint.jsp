...
<html>
    ...
    <body>
       ...
       <div class="new">
       <br><br><br>
       <a href="viewcomplaint.jsp"><b class="add">View Complaints</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="updatestatus.jsp"><b class="add">Update Status</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="open.jsp"><b class="add">Open</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <a href="closed.jsp"><b class="add">Closed</b></a>
       </div>
        </div>
