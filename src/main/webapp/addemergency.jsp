...
<html>
    ...
    <body>
       ...
       <center>
       <br>
       <b style="border-bottom:solid;">Add Emergency Contact</b><br><br>
       <form action="addemergencycode.jsp" method="post">
       <input type="text" name="name" placeholder="Name"><br><br>
        <input type="text" name="block" placeholder="Block"><br><br>
