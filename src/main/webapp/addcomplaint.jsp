...
<html>
    ...
    <body>
       ...
       <center>
       <br>
       <b style="border-bottom:solid;">Add Complaint</b><br><br>
       <form action="addcomplaintcode.jsp" method="post">
       <input type="text" name="name" placeholder="Name"><br><br>
        <input type="text" name="flatno" placeholder="FlatNo"><br><br>
        <input type="text" name="complaint" placeholder="Complaint"><br><br>
