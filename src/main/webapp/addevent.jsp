...
<html>
    ...
    <body>
       ...
       <center>
       <br>
       <b style="border-bottom:solid;">New Event</b><br><br>
       <form action="addeventcode.jsp" method="post">
       <input type="text" name="ename" placeholder="Event Name"><br><br>
        <input style="width:160px;" type="date" name="date" placeholder="Date"><br><br>
       <textarea rows="3" cols="20" name="desc" placeholder="Enter Info here"></textarea><br><br>
