...
<html>
    ...
    <body>
       ...
       <center>
       <br>
       <b style="border-bottom:solid;">Request Service</b><br><br>
       <form action="requestservicecode.jsp" method="post">
        <input type="text" name="flatno" placeholder="FlatNo"><br><br>
        <input type="text" name="phone" placeholder="PhoneNo"><br><br>
        Service:<select name="service">
        <option value="Watercan">Water Can</option>
        <option value="HouseKeeping">HouseKeeping</option>
        <option value="Gas">Gas</option>
        <option value="GarbageCollction">GarbageCollection</option>
