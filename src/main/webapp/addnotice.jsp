...
<html>
    ...
    <body>
       ...
       <center>
       <br>
       <b style="border-bottom:solid;">New Notice</b><br><br>
       <form action="addnoticecode.jsp" method="post">
       <input type="text" name="num" placeholder="Notice Num"><br><br>
        <input type="text" name="title" placeholder="Title"><br><br>
       <textarea rows="4" cols="20" name="notice" placeholder="Enter Notice here"></textarea><br><br><br>
