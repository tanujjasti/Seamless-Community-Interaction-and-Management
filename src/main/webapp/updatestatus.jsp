    ...
    <body>
        <div class="content">
          ...
          <a href="arequestservices.jsp"><p class="dash">Request Services</p></a>
            ...
            <a href="apartments.jsp"><p class="dash">Apartments</p></a>
            <a href="aparking.jsp"><p class="dash">Parking</p></a>
            <a href="aaemergency.jsp"><p class="dash">Emergency Contacts</p></a>
       ...
       <center>
       <br>
       <b style="border-bottom:solid;">Update Status</b><br><br>
       <form action="updatestatuscode.jsp" method="post">
