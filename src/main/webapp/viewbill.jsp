    ...
    <body>
        <div class="content">
          ...
          <a href="urequestservices.jsp"><p class="dash">Request Services</p></a>
            ...
            String id=(String)session.getAttribute("flatno");
            try{
                Class.forName("com.mysql.cj.jdbc.Driver");
            	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/community","root","tanuj20021008");
            	PreparedStatement ps=con.prepareStatement("select * from bills where flatno=?");
            	ps.setString(1,id);
       ...
       <caption style="color:black"><b>Maintanance Bill</b></caption>
       <tr>
       <th>No</th>
       <th>Flatno</th>
       <th>Amount</th>
