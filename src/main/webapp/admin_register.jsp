...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="block2">
                <p class="right-head">Fill these details to continue</p>
                <form action="adminregistercode.jsp" method="post">
                    <center>
                        <input class="box" type="text" name="uname" placeholder="Name"><p></p>
                        <input class="box1" type="id" name="aid" placeholder="Admin ID"><p></p>
                        ...
                        <input class="box1" type="text" name="sname" placeholder="Society Name"><p></p>
                        <input class="box1" type="text" name="address" placeholder="Society Address"><p></p>
